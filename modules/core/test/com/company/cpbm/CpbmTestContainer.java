...
public class CpbmTestContainer extends TestContainer {

    public CpbmTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/cpbm/app.properties",
    ...
    public static class Common extends CpbmTestContainer {

        public static final CpbmTestContainer.Common INSTANCE = new CpbmTestContainer.Common();
